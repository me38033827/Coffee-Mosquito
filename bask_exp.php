...
<?php 
    ...
    echo"<h1>经验交流</h1><br/><br/>";
    for($i=0;$i<count($paging->res);$i++){
        echo"<a href='bask_showInfo.php?id=".$paging->res[$i]['id']."&opt=bask_exp'><font color='black'>";
