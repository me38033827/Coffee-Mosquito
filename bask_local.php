...
<?php 
    ...
    echo"<h1>同城交友</h1><br/><br/>";
    for($i=0;$i<count($paging->res);$i++){
        echo"<a href='bask_showInfo.php?id=".$paging->res[$i]['id']."&opt=bask_local'><font color='black'>";
